...
# Set xvlog options
xvlog_opts="--incr --relax -L uvm -L cmac_usplus_v3_1_9"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L gtwizard_ultrascale_v1_7_13 -L xil_defaultlib -L cmac_usplus_v3_1_9 -L uvm -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot cmac_usplus_0 xil_defaultlib.cmac_usplus_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim cmac_usplus_0 -key {Behavioral:sim_1:Functional:cmac_usplus_0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb cmac_usplus_0.wdb xsim.dir)
